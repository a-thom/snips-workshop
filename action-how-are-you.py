...
INTENT_HOW_ARE_YOU = "a-thom:how_are_you"
INTENT_GOOD = "a-thom:feeling_good"
INTENT_BAD = "a-thom:feeling_bad"
INTENT_OKAY = "a-thom:feeling_okay"

INTENT_FILTER_FEELING = [INTENT_GOOD, INTENT_BAD, INTENT_OKAY]
...
def main():
    with Hermes("localhost:1883") as h:
        h.subscribe_intent(INTENT_HOW_ARE_YOU, how_are_you_callback) \
         ...
         .subscribe_intent(INTENT_OKAY, feeling_okay_callback) \
         .start()
...
def feeling_okay_callback(hermes, intent_message):
    session_id = intent_message.session_id
